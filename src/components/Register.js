...
export const Register = () => {
    ...
    function formValidation () {
        ...
        if (data.description.length > 0 && data.description.trim().length < 15) {
            isValid = false;
    ...
    return(
        <div className="form-container">
            ...
            <label htmlFor="profilePic">Profile picture <span className="optional">(optional)</span></label>
